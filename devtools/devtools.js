/**
 * UI Checker DevTools Extension - DevTools Page
 *
 * Creates the UI Checker panel and triggers an auto-scan when DevTools opens.
...
function connectLifecycle() {
  ...
  // Default ('panel'): wait until the user opens the UI Checker panel or sidebar.
